...
hi('NormalNC',     { fg = colors.gray9, bg = colors.bg })
...
hi('Visual',       { fg = colors.fg, bg = colors.selection })
...
hi('PmenuSbar',    { fg = colors.gray7, bg = colors.gray3 })
hi('PmenuThumb',   { fg = colors.gray9, bg = colors.gray5 })
...
hi('QuickFixLine', { fg = colors.fg, bg = colors.gray2 })
...
hi('DiagnosticUnnecessary', { fg = colors.hint, undercurl = true })
hi('DiagnosticDeprecated',  { fg = colors.gray7, strikethrough = true })
...
hi('@lsp.type.comment',  {})
hi('@lsp.type.keyword',  {})
-- Clear variable so TS sub-captures (@variable.parameter, @variable.builtin) win.
...
hi('@variable.builtin',          { fg = colors.red, italic = true })
...
hi('@markup.heading.1',      { fg = colors.blue, bold = true })
hi('@markup.heading.2',      { fg = colors.cyan, bold = true })
hi('@markup.heading.3',      { fg = colors.green, bold = true })
hi('@markup.heading.4',      { fg = colors.yellow, bold = true })
hi('@markup.heading.5',      { fg = colors.magenta, bold = true })
hi('@markup.heading.6',      { fg = colors.gray9, bold = true })
...
hi('BlinkCmpLabelDeprecated',   { fg = colors.gray7, strikethrough = true })
hi('BlinkCmpLabelDescription',  { link = 'BaseSubtext' })
hi('BlinkCmpKind',              { link = 'BaseFg' })
hi('BlinkCmpKindText',          { link = 'BaseString' })
hi('BlinkCmpKindMethod',        { link = 'BaseFunction' })
hi('BlinkCmpKindFunction',      { link = 'BaseFunction' })
hi('BlinkCmpKindConstructor',   { link = 'BaseType' })
hi('BlinkCmpKindField',         { link = 'BaseProperty' })
hi('BlinkCmpKindVariable',      { link = 'BaseIdentifier' })
hi('BlinkCmpKindClass',         { link = 'BaseType' })
hi('BlinkCmpKindInterface',     { link = 'BaseType' })
hi('BlinkCmpKindModule',        { link = 'BasePreProc' })
hi('BlinkCmpKindProperty',      { link = 'BaseProperty' })
hi('BlinkCmpKindUnit',          { link = 'BaseNumber' })
hi('BlinkCmpKindValue',         { link = 'BaseConstant' })
hi('BlinkCmpKindEnum',          { link = 'BaseType' })
hi('BlinkCmpKindKeyword',       { link = 'BaseKeyword' })
hi('BlinkCmpKindSnippet',       { link = 'BaseSpecial' })
hi('BlinkCmpKindColor',         { link = 'BaseSpecial' })
hi('BlinkCmpKindFile',          { link = 'BaseIdentifier' })
hi('BlinkCmpKindReference',     { link = 'BaseConstant' })
hi('BlinkCmpKindFolder',        { link = 'BaseIdentifier' })
hi('BlinkCmpKindEnumMember',    { link = 'BaseConstant' })
hi('BlinkCmpKindConstant',      { link = 'BaseConstant' })
hi('BlinkCmpKindStruct',        { link = 'BaseType' })
hi('BlinkCmpKindEvent',         { link = 'BaseSpecial' })
hi('BlinkCmpKindOperator',      { link = 'BaseOperator' })
hi('BlinkCmpKindTypeParameter', { link = 'BaseType' })
hi('BlinkCmpGhostText',         { link = 'BaseComment' })
hi('BlinkCmpDoc',               { link = 'NormalFloat' })
hi('BlinkCmpDocBorder',         { link = 'FloatBorder' })
hi('BlinkCmpSignatureHelp',     { link = 'NormalFloat' })
hi('BlinkCmpSignatureHelpActiveParameter', { fg = colors.orange, bold = true })
...
hi('TelescopePromptPrefix',  { link = 'BaseKeyword' })
...
hi('TelescopeSelectionCaret',{ link = 'BaseKeyword' })
