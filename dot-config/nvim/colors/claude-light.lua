-- High Contrast Light Theme for Neovim
...
-- Editor highlights
hi('Normal', { fg = colors.black, bg = colors.white })
...
-- Line numbers
hi('LineNr', { fg = colors.gray5 })
hi('SignColumn', { fg = colors.gray5, bg = colors.white })
...
-- Search
hi('Search', { fg = colors.white, bg = colors.yellow })
hi('IncSearch', { fg = colors.white, bg = colors.orange })
hi('CurSearch', { fg = colors.white, bg = colors.bright_yellow })

-- Matching
hi('MatchParen', { fg = colors.cyan, bg = colors.gray2, bold = true })

-- Splits
hi('VertSplit', { fg = colors.gray4, bg = colors.white })
hi('WinSeparator', { fg = colors.gray4, bg = colors.white })

-- Status line
hi('StatusLine', { fg = colors.black, bg = colors.gray2 })
...
hi('TabLineSel', { fg = colors.black, bg = colors.gray3, bold = true })

-- Popup menu
hi('Pmenu', { fg = colors.black, bg = colors.gray2 })
...
hi('FoldColumn', { fg = colors.gray6, bg = colors.white })

-- Diff
hi('DiffAdd', { fg = colors.green, bg = colors.white })
hi('DiffChange', { fg = colors.yellow, bg = colors.white })
hi('DiffDelete', { fg = colors.red, bg = colors.white })
hi('DiffText', { fg = colors.blue, bg = colors.white, bold = true })
...
hi('ModeMsg', { fg = colors.black, bold = true })
...
hi('Error', { fg = colors.red, bg = colors.white, bold = true })
hi('Todo', { fg = colors.white, bg = colors.yellow, bold = true })
...
hi('@lsp.type.field', { fg = colors.black })
...
hi('@lsp.type.parameter', { fg = colors.black })
hi('@lsp.type.property', { fg = colors.black })
...
hi('@lsp.type.variable', { fg = colors.black })
hi('@lsp.typemod.parameter.declaration', { fg = colors.black, bold = true })
hi('@lsp.typemod.variable.static', { fg = colors.black, italic = true })
...
hi('@lsp.type.field.cs', { fg = colors.black })
...
hi('@lsp.type.local.cs', { fg = colors.black })
...
hi('@lsp.type.parameter.cs', { fg = colors.black })
hi('@lsp.type.property.cs', { fg = colors.black })
...
hi('@lsp.type.variable.cs', { fg = colors.black })
...
hi('@lsp.typemod.field.static.cs', { fg = colors.black, italic = true })
...
hi('@lsp.typemod.parameter.defaultLibrary.cs', { fg = colors.black, bold = true })
hi('@lsp.typemod.property.readonly.cs', { fg = colors.black, italic = true })
hi('@lsp.typemod.property.static.cs', { fg = colors.black, italic = true })
hi('@lsp.typemod.variable.readonly.cs', { fg = colors.black, italic = true })
...
hi('@lsp.type.parameter.ruby', { fg = colors.black })
hi('@lsp.type.property.ruby', { fg = colors.black })
hi('@lsp.type.string.ruby', { fg = colors.green })
hi('@lsp.type.variable.ruby', { fg = colors.black })
...
hi('@keyword', { fg = colors.blue })
hi('@label', { fg = colors.blue })
hi('@markup.italic', { fg = colors.black, italic = true })
hi('@markup.link', { fg = colors.cyan, underline = true })
hi('@markup.strong', { fg = colors.black, bold = true })
hi('@method.call', { fg = colors.magenta })
hi('@method', { fg = colors.magenta })
hi('@module', { fg = colors.yellow })
hi('@namespace', { fg = colors.yellow })
hi('@none', { fg = colors.black })
hi('@number', { fg = colors.orange })
hi('@operator', { fg = colors.orange })
hi('@parameter.reference', { fg = colors.black })
hi('@parameter', { fg = colors.black })
hi('@property', { fg = colors.black })
...
hi('@tag', { fg = colors.magenta })
hi('@text.danger', { fg = colors.white, bg = colors.error, bold = true })
hi('@text.emphasis', { fg = colors.black, italic = true })
...
hi('@text.note', { fg = colors.white, bg = colors.info, bold = true })
hi('@text.reference', { fg = colors.cyan })
hi('@text.strike', { fg = colors.black, strikethrough = true })
hi('@text.strong', { fg = colors.black, bold = true })
hi('@text.title', { fg = colors.blue, bold = true })
hi('@text.todo', { fg = colors.white, bg = colors.yellow, bold = true })
hi('@text.underline', { fg = colors.black, underline = true })
hi('@text.uri', { fg = colors.cyan, underline = true })
hi('@text.warning', { fg = colors.white, bg = colors.warning, bold = true })
hi('@text', { fg = colors.black })
...
hi('@variable.parameter', { fg = colors.black })
hi('@variable', { fg = colors.black })
...
hi('@variable.css', { fg = colors.black })
...
hi('@variable.scss', { fg = colors.black })
hi('@namespace.scss', { fg = colors.yellow })
hi('@string.special.scss', { fg = colors.orange })
hi('@character.special.scss', { fg = colors.orange })

-- JavaScript/TypeScript
hi('@variable.javascript', { fg = colors.black })
hi('@variable.typescript', { fg = colors.black })
hi('@property.javascript', { fg = colors.black })
hi('@property.typescript', { fg = colors.black })
...
hi('@parameter.javascript', { fg = colors.black })
hi('@parameter.typescript', { fg = colors.black })
hi('@field.javascript', { fg = colors.black })
hi('@field.typescript', { fg = colors.black })
...
hi('@variable.parameter.javascript', { fg = colors.black })
hi('@variable.parameter.typescript', { fg = colors.black })
...
-- Python
hi('@variable.python', { fg = colors.black })
...
hi('@parameter.ruby', { fg = colors.black })
hi('@property.ruby', { fg = colors.black })
...
hi('@variable.ruby', { fg = colors.black })
...
hi('@variable.rust', { fg = colors.black })

-- Go
hi('@type.go', { fg = colors.yellow })
hi('@variable.go', { fg = colors.black })

-- C/C++
hi('@type.c', { fg = colors.yellow })
hi('@type.cpp', { fg = colors.yellow })
hi('@variable.c', { fg = colors.black })
hi('@variable.cpp', { fg = colors.black })

-- C#
hi('@type.c_sharp', { fg = colors.yellow })
hi('@type.cs', { fg = colors.yellow })
hi('@variable.c_sharp', { fg = colors.black })
hi('@variable.cs', { fg = colors.black })
hi('@property.c_sharp', { fg = colors.black })
hi('@property.cs', { fg = colors.black })
hi('@field.c_sharp', { fg = colors.black })
hi('@field.cs', { fg = colors.black })
...
hi('@parameter.c_sharp', { fg = colors.black })
hi('@parameter.cs', { fg = colors.black })
...
hi('@variable.member.cs', { fg = colors.black })
...
hi('CodeCompanionChatHeader', { fg = colors.black, bold = true })
...
hi('CodeCompanionChatVariable', { fg = colors.black })
hi('CodeCompanionVirtualText', { fg = colors.gray8 })

-- Markview highlight groups
hi('MarkviewPalette0', { fg = colors.black, bg = colors.gray2 })
hi('MarkviewPalette0Fg', { fg = colors.black })
hi('MarkviewPalette0Bg', { bg = colors.gray2 })
hi('MarkviewPalette0Sign', { fg = colors.black, bg = colors.gray2 })
...
hi('MarkviewCode', { fg = colors.black, bg = colors.white })
hi('MarkviewCodeInfo', { fg = colors.gray7, bg = colors.white })
hi('MarkviewCodeFg', { fg = colors.black })
hi('MarkviewInlineCode', { fg = colors.green, bg = colors.white })
...
hi('TelescopeNormal', { fg = colors.black, bg = colors.white })
hi('TelescopeBorder', { fg = colors.gray4, bg = colors.white })
hi('TelescopePromptBorder', { fg = colors.gray4, bg = colors.white })
hi('TelescopeResultsBorder', { fg = colors.gray4, bg = colors.white })
hi('TelescopePreviewBorder', { fg = colors.gray4, bg = colors.white })
hi('TelescopeSelection', { fg = colors.black, bg = colors.gray2 })
hi('TelescopeSelectionCaret', { fg = colors.orange, bg = colors.gray2 })

-- NvimTree (if installed)
hi('NvimTreeNormal', { fg = colors.black, bg = colors.white })
...
hi('WhichKeyDesc', { fg = colors.black })
